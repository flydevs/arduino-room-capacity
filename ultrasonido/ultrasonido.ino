...
void setup() {
  ...
  pinMode(12, OUTPUT); //salida del pulso generado por el sensor ultrasónico 
...
if (sensor1){
  ...
  playSong2();
    ...
    digitalWrite(13, LOW);//envió del pulso.
    noTone(buzzer);
}
